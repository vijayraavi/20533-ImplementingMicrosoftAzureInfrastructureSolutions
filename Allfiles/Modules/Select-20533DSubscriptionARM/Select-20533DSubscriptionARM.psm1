Function Select-20533DSubscriptionARM
...

{
    ...
    elseif($20533DsubscriptionIdGlobal)
    {
        ...
        Write-Host "Subscription already selected - using the subscription: $subscriptionName Id: $20533DsubscriptionIdGlobal"
        Set-AzureRmContext -SubscriptionId $20533DsubscriptionIdGlobal
    }
            ...
            if([int32]::TryParse($selectedSub, [ref]$selectedEntry) -eq $true)
            {
                if($selectedEntry -ge 1 -and $selectedEntry -lt ($subs.Count + 1))
                {
                    if ($subs[$selectedEntry - 1].Id -eq $null) {
		    	        ...
		    	        $global:20533DsubscriptionIdGlobal = $subs[$selectedEntry - 1].SubscriptionId
		            } else {
                        ...
                        $global:20533DsubscriptionIdGlobal = $subs[$selectedEntry - 1].Id
		            }
                    break               
                }
            }
