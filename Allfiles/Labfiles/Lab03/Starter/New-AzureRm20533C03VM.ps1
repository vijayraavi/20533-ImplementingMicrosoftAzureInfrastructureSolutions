...
$storageAccount	= Get-AzureRmStorageAccount | Where-Object {($_.Location -eq $location) -and ($_.ResourceGroupName -eq $rgName) -and ($_.StorageAccountName -like "*disk*")}
...
$pipName = '20533C0301pip' + $uniqueNumber
$nicName = '20533C0301nic' + $uniqueNumber
