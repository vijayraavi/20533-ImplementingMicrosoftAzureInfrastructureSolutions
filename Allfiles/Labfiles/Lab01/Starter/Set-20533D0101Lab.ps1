...
# Variables
$rg1Name 	= '20533D0101-LabRG' # test resource group created in Exercise 2
$rg2Name 	= '20533D0102-LabRG' # resource group name to which you will move the resource
$resName	= '20533D0101-rt' # test resource created in Exercise 2
