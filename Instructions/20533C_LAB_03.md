...
3. From the Azure portal, create an Azure Resource Manager virtual machine with the following parameters:
...
3. From the Solution Explorer, start a new deployment process for the first virtual machine.

4. Deploy a new virtual machine into the **20533C0301-LabRG** resource group, by using the following parameter values:
