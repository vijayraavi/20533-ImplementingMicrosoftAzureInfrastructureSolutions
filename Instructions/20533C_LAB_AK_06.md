...
3. On the  **Hub** menu, click **New**, and then click  **Storage**.
...
2. On the  **Hub** menu, click **More services**, and then click  **Storage accounts (classic)**.
...
6. On the  **Hub** menu, click **More services**, and then click  **Storage accounts (classic)**.

7. In the Storage accounts (classic) blade, click the storage account that you created in the previous exercise, and then in the blade for your storage account, click  **Access Keys**.
