...
18. Switch to Windows PowerShell ISE window, in the script pane, replace `[storage account access key]` with the content of Clipboard. and then press the **F5** key to execute the command.
