...
1. Open Windows PowerShell window and authenticate to your Azure subscription by signing in using the Microsoft account that is either the Service Administrator or a Co-administrator of your subscription.
...
1. In the Azure portal, download a publishing profile for the web app you just created.

2. Open the project in **D:\LabFiles\Lab05\Starter\AdatumWebsite\AdatumWebsite.sln** in Visual Studio:

3. Start the Publish Web Wizard, and then import the publish settings file that you just downloaded. 
...
5. Publish the web app, and then close Microsoft Edge and Visual Studio.
