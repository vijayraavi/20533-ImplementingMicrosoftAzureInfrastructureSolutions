...
9. Locate the value of the  **AdatumAdsDbConnectionString** element of the **AdatumAdsWorkerRole** role in the **ServiceConfiguration.Cloud.cscfg** file.

10. Replace the value of the  **AdatumAdsDbConnectionString** element with the ADO.NET connection string copied to the Clipboard.
