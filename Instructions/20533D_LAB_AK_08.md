...
4. In the Azure portal, click **+ New**. On the **New** blade, click **Databases** and then click **SQL Database**.
...
- Location: the Azure region you identified in step 4 of this task
