...
1. In the Azure portal, navigate to the web app blade and, in the **Essentials** section, click the **URL** link for your web app. This will open another tab in the Internet Explorer window. Note the color scheme.
