...
> **Note**: The entry **MIA-CL1.** is case-sensitive and includes the trailing period. If the Delete (de-register) does not complete, the Recovery Services Vault cannot be deleted later. If this happens just continue with the next exercise.
...
> **Note**: Wait for the vault to be deleted. If the Delete (de-register) did not complete earlier, the Recovery Services Vault cannot be deleted. If this happens just continue with the next exercise.
