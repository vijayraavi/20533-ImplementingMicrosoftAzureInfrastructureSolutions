...
3. At the Windows PowerShell command prompt, type the following commands, press Enter after each, and observe the results:
...
4. On the Azure classic portal, check that the changes that you made to the user accounts have replicated to Azure; if you do not see any changes, wait for a few minutes, and then refresh the page.
