...
7. On the Add Automation Account blade, specify the following:
  ...
  - Resource group: _ensure that the **Create new** option is selected and type **20533C1102-LabRG** in the text box_
...
3. On the LabAutomationAccount blade click the **ASSETS** tile.

4. On the **Assets** blade, notice that you have several Windows PowerShell modules included in your account by default.

5. Click the **Variables** tile.

6. On the **Variables** blade, click **Add a variable**.

7. On the **New Variable** blade, specify the following and click **Create**:
...
1. Repeat the steps 6 and 7 to create additional two non-encrypted string variables. For each variable, specify the following name, description and value::
...
1. Scroll back to the **Assets** blade and click the **Schedules** tile.

2. On the **Schedules** blade, click **Add a schedule**.

3. On the **New Schedule** blade, specify the following and click **Create**:
...
1. Close the Schedules blade.

2. Click **Connections**. 

3. Note two precreated connections **AzureClassicRunAsConnection** and **AzureRunAsConnection**. They were created automatically during provisioning of the Automation account since you selected the option to create the Azure Run As account.
...
1. On the Runbooks blade, click **Stop-AzureVMs-Workflow**

2. On the Stop-AzureVMs-Workflow blade, click **Edit**.

3. On the Edit PowerShell Workflow Runbook blade, review the content of the PowerShell workflow.
