...
8. Repeat the steps 6 and 7 to create additional two non-encrypted string variables. For each variable, specify the following name, description and value::
...
9. Scroll back to the **Assets** blade and click the **Schedules** tile.

10. On the **Schedules** blade, click **Add a schedule**.

11. On the **New Schedule** blade, specify the following and click **Create**:
...
12. Close the Schedules blade.

13. Click **Connections**. 

14. Note two precreated connections **AzureClassicRunAsConnection** and **AzureRunAsConnection**. They were created automatically during provisioning of the Automation account since you selected the option to create the Azure Run As account.

15. Close the Assets blade.
