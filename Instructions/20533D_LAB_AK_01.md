...
10. On the **Dashboard** page, in the hub menu, click **All services**, and then, in the service menu, click the star beside **Availability sets**. Close the service menu and verify that the **Availability sets** entry appears at the bottom of the hub menu. Leave the Microsoft Edge window open.
