...
4. On the **Dashboard** page, right-click the **All resources** tile, and then click **4x6**.
...
10. On the **Dashboard** page, in the hub menu, click **More services**, and then, in the service menu, click the star beside **Virtual machine scale sets**. Close the service menu and verify that the **Virtual machine scale sets** entry appears at the bottom of the hub menu. Leave the Microsoft Edge window open.
