...
1. Refresh the Mirosoft Edge window displaying the Azure portal. Next, click the "Directory and subscription" filter near to your name in the upper right corner of the Azure portal and, in the "Directory + Subscription" blade, click the name of the Azure Active Directory tenant you created in the previous task.
