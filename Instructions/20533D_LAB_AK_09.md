...
3. When prompted to sign in, specify the full user name (including the @_domain name_.onmicrosoft.com suffix) of the Mario Ledford's account you created in the previous exercise and **Pa55w.rd123** as the corresponding password. 
...
13. Restart Microsoft Edge and browse back to **https://myapps.microsoft.com**. If prompted to sign in, specify the full user name (including the @_domain name_.onmicrosoft.com suffix) of the Mario Ledford's account you created in the previous exercise and **Pa55w.rd123** as the corresponding password. 
