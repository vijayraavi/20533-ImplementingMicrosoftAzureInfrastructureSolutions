...
18. On the **Update your password** page, in the **Current password** box, type again the temporary password. In the **New password** and **Confirm password** text boxes, type **Pa55w.rd**, and click **Update password and sign in**.
...
23. On the **Update your password** page, in the **Current password** box, type the temporary password. In the **New password** and**Confirm password** boxes, type**Pa55w.rd**, and click **Update password and sign in**.
...
5. Click **Multi-Factor Authentication**. This will open another Microsoft Edge tab. If prompted, sign in using the Microsoft account that is the Service Administrator of your subscription.
...
3. On the **adatum** blade, click **Devices (preview)**.

4. On the **Devices (Preview) - All devices** blade, click **Device settings**.
...
11. On the **Enter password** page, type **Pa55w.rd** and click **Sign in**. 
