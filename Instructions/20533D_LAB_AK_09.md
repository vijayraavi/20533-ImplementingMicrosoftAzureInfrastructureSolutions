...
1. Start Internet Explorer and browse to [**https://myapps.microsoft.com**](https://myapps.microsoft.com).
...
6. Switch to the Internet Explorer window and, on the Apps page, click **Skype**. 

7. In the **Skype** dialog box, click **Install Now**.

8. When prompted whether to run or save **Access Panel Extension.msi**, click **Run**.

9. On the **Welcome to the Access Panel Extension Setup Wizard** page, click **Next**.

10. On the **Install Access Panel Extension** page, click **Install**.

11. When prompted, in the **User Account Control** dialog box, click **Yes**. This will close all **Internet Explorer** windows.

12. On the **Complete the Access Panel Extension Setup Wizard** page, click **Finish**.

13. This will open a new Internet Explorer window. When prompted, click **Enable** and close the Internet Explorer window.

14. Open an Internet Explorer window and, if prompted, sign it back using credentials of Mario Ledford's user account. 

15. In the new Internet Explorer window, browse again to [**https://myapps.microsoft.com**](https://myapps.microsoft.com). If prompted to sign in, specify the full user name (including the @_domain name_.onmicrosoft.com suffix) of the Mario Ledford's account you created in the previous exercise and **Pa55w.rd** as the corresponding password. 
...
18. Click the user name in the upper right corner of the Microsoft Edge page and click **Sign out**.
