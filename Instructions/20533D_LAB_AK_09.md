...
3. In the Azure portal, in the hub menu, click **+ Create resource**, click **Security + Identity** and then, click **Azure Active Directory**.
...
2. In the hub menu of the Azure portal, click **All services** and, in the service menu, click **Azure Active Directory**. This will display the **adatum** Azure Active Directory tenant blade.
...
16. Start an InPrivate Mirosoft Edge session and browse to the Azure portal at [**https://portal.azure.com**](https://portal.azure.com).
...
21. Start an InPrivate Mirosoft Edge window and browse to the Azure portal at [**https://portal.azure.com**](https://portal.azure.com).
