...
5. Browse to the folder E:\\LabFiles\\Lab05\\Starter\\AdatumWebsite, click **AdatumWebsite.sln**, and then click **Open**. If prompted, in the **Security Warning for AdatumWebsite** dialog box, clear the checkbox **Ask me for every project in this solution** and click **OK**.
