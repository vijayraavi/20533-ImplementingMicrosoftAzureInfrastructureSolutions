...
3. On the Publish page, click the right pointing arrow head.
...
11. On the Publish page, click the right pointing arrow head.

12. In the list of publishing options, click **Import Profile** and then click **Publish**. 

13. In the **Import Publish Settings** dialog box, browse to the **Downloads** folder.

14. Select the **.PublishSettings** file that you downloaded in step 5 of this task, and then click **Open**.
