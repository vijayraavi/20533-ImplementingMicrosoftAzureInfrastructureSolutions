...
4. In the list of publishing options, click **Import Profile** and then click **Publish**. 
...
11. In the list of publishing options, click **Import Profile** and then click **Publish**.  If **Import Profile** is not listed, you may need to click the right pointing arrow head to display additional publishing options. 

12. In the **Import Publish Settings** dialog box, browse to the **Downloads** folder.

13. Select the **.PublishSettings** file that you downloaded in step 5 of this task, and then click **Open**.
...
1. In Microsoft Edge, in the Azure portal, on the traffic Manager profile blade, click **Overview**, waith until the ONLINE column displays the **Online** status for both web apps, and then, click the link under the **DNS name** section.
