...
5. In the Remote Desktop session , start Internet Explorer and navigate to [**https://docs.docker.com/docker-for-windows/install/**](https://docs.docker.com/docker-for-windows/install/)

6. On the **Install Docker for Windows** page, click **Download from Docker Store**.

7. On the **Docker Community Edition for Windows** page, click **Get Docker CE for Windows (stable)**.

8. Once the installation completed, click **Close and log out**.
