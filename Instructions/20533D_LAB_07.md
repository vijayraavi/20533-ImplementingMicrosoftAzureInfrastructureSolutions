...
11. From the **Administrator: Command Prompt** window, create a new Azure VM configured as Docker host by running **docker-machine** with the following settings:
  ...
  - --azure-static-public-ip: **"20533d0702-vm0"**
