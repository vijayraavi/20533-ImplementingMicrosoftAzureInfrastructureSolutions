...
1. In Internet Explorer, in the Azure Portal, in the Hub menu, click  **More services**, and then click  **SQL Database**. 
...
>  **Note:** If the initial restore attempt fails, wait a few minutes then try again.
