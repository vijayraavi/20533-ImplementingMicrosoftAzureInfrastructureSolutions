...
20. Select the text between the **-----BEGIN CERTIFICATE------** and **------END CERTIFICATE------** lines and press **Ctrl+C**

21. Switch back to Internet Explorer.

22. Paste the copied text into the **PUBLIC CERTIFICATE DATA** textbox on the **gatewayARM - Point-to-site configuration** blade of the Azure portal. 

23. In the **NAME** text box to the left, type **AdatumRootCertificate** and click **Save**.

24. Switch back to the Command Prompt window.
...
26. Switch back to the Certificates console and refresh the view of **Certificates** folder under the **Personal** folder. 

27. Verify that both the **AdatumClientCertificate** and ** AdatumRootCertificate** display in the Personal store.

28. Close the Certificates console.
