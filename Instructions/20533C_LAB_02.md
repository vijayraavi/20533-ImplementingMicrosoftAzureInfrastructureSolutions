...
1.	In the **Resource Group** section, locate the **Create new** radio button and select it.

2. 	In the **Resource Group** section, locate the dialog box and enter **AdatumLabRG** as the name of the *Resource Group*.

3. In the Custom Deployment blade under Resource group location drop-down list select  _&lt;Location1>._

4. In the Custom Deployment blade, click  **Legal Terms** link. Review the Terms of use, and then click **Purchase**.

5. In the custom deployment blade, click  **Create** to create the new virtual network.

6. Verify that provisioning of the new virtual network with name  **HQ** completed successfully
