...
8. Copy the the text between the **-----BEGIN CERTIFICATE------** and **------END CERTIFICATE------** lines

9. Paste the copied text into the **PUBLIC CERTIFICATE DATA** textbox on the **gatewayARM - Point-to-site configuration** blade of the Azure portal. 

10. In the **NAME** text box to the left, type **AdatumRootCertificate** and save the change.
...
13. Switch back to the Certificates console, verify that both the **AdatumClientCertificate** and ** AdatumRootCertificate** display in the Personal store.
