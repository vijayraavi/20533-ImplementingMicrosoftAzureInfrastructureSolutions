...
6. Navigate to the **20533D0401-avset** blade and note that the availability set has 3 fault domains, 5 update domains, and it contains two virtual machines. Also note that each VM has a unique fault domain and update domain. 
...
2. In the E:\\Labofiles\\Lab04\\Starter folder, right-click on the **IISInstall.ps1** file and select **Edit** from the right-click menu. This will open the file in the **Windows PowerShell ISE**.
...
9. Initiate a Remote Desktop session to **20533D0201-vm1** from the Azure portal.
