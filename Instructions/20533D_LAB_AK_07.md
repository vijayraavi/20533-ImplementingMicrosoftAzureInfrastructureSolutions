...
> **Note**: For the region selection you can choose "southeastasia" and for the VM sizee "Standard_D2s_v3". This area and this size supports nested virtualization.
...
> **Note**: Be careful when copying this part. Copy even the blank space on the right of the text (it should be 2 spaces).
