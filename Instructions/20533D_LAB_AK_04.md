...
7. On the 20533D0401-avset blade, note that the availability set has 2 or 3 fault domains (depending on the Azure region), 5 update domains, and it contains two virtual machines. Also note that each VM has a unique fault domain and update domain. 
