...
1. In SQL Server Management Studio, in Object Explorer, verify that the **operations** database appears in the list of databases.
...
2. On the SQL server blade, navigate to the **Deleted databases** blade. 

3. From the **Deleted databases** blade, initiate a restore of the **operations** database. Make sure to change the automatically assigned name of the restored database back to **operations**.
