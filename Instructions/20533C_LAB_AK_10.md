...
3. In Notepad, select the first 8 lines in the file, down to, but without the the line starting with **#SIG # Begin signature block**
...
1. Start another Internet Explorer window and browse to https://www.microsoft.com/en-us/download/details.aspx?id=47594

2. On the **Microsoft Azure Active Directory Connect** page, click **Download**.
