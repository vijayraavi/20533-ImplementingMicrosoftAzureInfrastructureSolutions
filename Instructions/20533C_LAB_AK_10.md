...
1. On the **Connect your directories** page, verify that the **adatum.com** forest is selected and click **Add Directory**

2. On the **AD Forest Account** window, under user name, type **ADATUM\\Student** with the password **Pa55w.rd1234**, click **OK**, and click **Next**.
