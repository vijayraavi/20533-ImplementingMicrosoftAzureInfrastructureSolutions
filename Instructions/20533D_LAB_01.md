...
In the Azure portal, you must observe the organization of resources and customize the interface to make your testing environment more accessible. In the Azure Account Center, you must view and download your current billing data. In the Azure classic portal, you must identify the association between your subscription and an Azure AD tenant
...
2. Start Microsoft Edge, browse to the Azure classic portal and sign in by using the Microsoft account that is the Service Administrator of your Azure subscription.

3. In the Azure classic portal, view the Azure AD tenant asssociated with your Azure subscription.
