...
2. On the **Connect to virtual machine** blade, click **Download RDP File**.
...
8. Once you are connected to 20533D0202-vm1 via the Remote Desktop session, click **Start** and click **Windows PowerShell**.
...
10. Verify that test is successful and note that the connection was routed over 10.0.0.4
